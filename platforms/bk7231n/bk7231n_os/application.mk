...
APP_MK_NAME := $(TOP_DIR)/${APP_DIR}/$(APP_BIN_NAME)/components.mk
COMP_SRCS =
...
COMP_SRC_DIRS += $(foreach n, $(COMPONENTS_LIB), $(shell find $(TOP_DIR)/components/$(n)/src -type d))
TY_INC_DIRS += $(foreach n, $(COMPONENTS_LIB), $(shell find $(TOP_DIR)/components/$(n)/include -type d))

COMP_SRCS += $(foreach dir, $(COMP_SRC_DIRS), $(wildcard $(dir)/*.c))
COMP_SRCS += $(foreach dir, $(COMP_SRC_DIRS), $(wildcard $(dir)/*.cpp))
COMP_SRCS += $(foreach dir, $(COMP_SRC_DIRS), $(wildcard $(dir)/*.cc))
